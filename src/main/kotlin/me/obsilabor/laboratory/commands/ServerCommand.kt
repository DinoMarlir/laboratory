...
class ServerCommand : CliktCommand(
    ...
    class Modify : CliktCommand(
        ...
        private val query by argument("query", help = "Name or id of the server to modify")
    ...
    class Delete : CliktCommand(
        ...
        private val query by argument("query", help = "Name or id of the server to delete")
