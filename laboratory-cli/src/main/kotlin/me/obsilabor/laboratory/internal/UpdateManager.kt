...
object UpdateManager {
    ...
    suspend fun updateOnWindows() {
        ...
        downloadFileV2("https://raw.githubusercontent.com/DinoMarlir/laboratory/dev/chemicae/.meta/winupdater.jar", laboratoryDir.resolve("winupdater.jar").toPath())
        terminal.println(TextColors.brightYellow("Do NOT run laboratory within the next 5 seconds to avoid update-issues."))
    ...
    suspend fun getLatestVersion(): String {
        return httpClient.get("https://raw.githubusercontent.com/DinoMarlir/laboratory/${Config.userConfig.updateBranch}/.meta/version").bodyAsText()
    }

    suspend fun getDownloadURL(version: String): String {
        return httpClient.get("https://raw.githubusercontent.com/DinoMarlir/laboratory/${Config.userConfig.updateBranch}/.meta/release-repo.txt").bodyAsText().replace("\${version}", version)
    }
