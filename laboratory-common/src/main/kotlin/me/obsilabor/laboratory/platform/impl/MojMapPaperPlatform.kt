...
object MojMapPaperPlatform : IPlatform {
    override val name = "paper-mojmap"
    override val jarNamePattern = "paper-mojmap-\$mcVersion-\$build.jar"
    override val coloredName = TextColors.red(name)
    ...
    override suspend fun downloadJarFile(path: Path, mcVersion: String, build: String): Boolean {
        val url = "https://api.papermc.io/v2/projects/paper/versions/$mcVersion/builds/$build/downloads/paper-mojmap-$mcVersion-$build.jar"
        runCatching {
